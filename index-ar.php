...
?>
        ...
        <div class="tns-carousel-inner" data-carousel-options="{&quot;mode&quot;: &quot;gallery&quot;, &quot;responsive&quot;: {&quot;0&quot;:{&quot;nav&quot;:true, &quot;controls&quot;: false},&quot;992&quot;:{&quot;nav&quot;:false, &quot;controls&quot;: true}}}">
            ...
            <div class="d-lg-flex justify-content-between align-items-center ps-lg-4"><img class="d-block order-lg-2 me-lg-n5 flex-shrink-0" src="img/home/hero-slider/01.jpg" alt="Summer Collection">
              <div class="position-relative mx-auto me-lg-n5 py-5 px-4 mb-lg-5 order-lg-1" style="max-width: 42rem; z-index: 10;">
                <div class="pb-lg-5 mb-lg-5 text-center text-lg-start text-lg-nowrap">
                  <h3 class="h2 text-light fw-light pb-1 from-start">لقد وصل للتو!</h3>
                  <h2 class="text-light display-5 from-start delay-1">مجموعة الصيف الضخمة</h2>
                  <p class="fs-lg text-light pb-3 from-start delay-2">ملابس السباحة ، والبلوزات ، والسراويل القصيرة ، والنظارات الشمسية وأمبير. أكثر بكثير...</p>
          ...
          <div class="px-lg-5" style="background-color: #f5b1b0;">
            <div class="d-lg-flex justify-content-between align-items-center ps-lg-4"><img class="d-block order-lg-2 me-lg-n5 flex-shrink-0" src="img/home/hero-slider/02.jpg" alt="Women Sportswear">
              <div class="position-relative mx-auto me-lg-n5 py-5 px-4 mb-lg-5 order-lg-1" style="max-width: 42rem; z-index: 10;">
                <div class="pb-lg-5 mb-lg-5 text-center text-lg-start text-lg-nowrap">
                  <h3 class="h2 text-light fw-light pb-1 from-bottom">أسرع - بسرعة! عرض لوقت محدود.</h3>
                  <h2 class="text-light display-5 from-bottom delay-1">بيع الملابس الرياضية النسائية</h2>
                  <p class="fs-lg text-light pb-3 from-bottom delay-2">أحذية رياضية ، Keds ، بلوزات ، هوديس وأمبير. أكثر بكثير...</p>
                  <div class="d-table scale-up delay-4 mx-auto mx-lg-0"><a class="btn btn-primary" href="shop-grid-ls.html">تسوق الآن<i class="ci-arrow-right ms-2 me-n1"></i></a></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="px-lg-5" style="background-color: #eba170;">
            <div class="d-lg-flex justify-content-between align-items-center ps-lg-4"><img class="d-block order-lg-2 me-lg-n5 flex-shrink-0" src="img/home/hero-slider/03.jpg" alt="Men Accessories">
              <div class="position-relative mx-auto me-lg-n5 py-5 px-4 mb-lg-5 order-lg-1" style="max-width: 42rem; z-index: 10;">
                <div class="pb-lg-5 mb-lg-5 text-center text-lg-start text-lg-nowrap">
                  <h3 class="h2 text-light fw-light pb-1 from-top">أكمل مظهرك مع</h3>
                  <h2 class="text-light display-5 from-top delay-1">اكسسوارات رجالية جديدة</h2>
                  <p class="fs-lg text-light pb-3 from-top delay-2">القبعات &amp; قبعات ، نظارات شمسية ، حقائب &amp; أكثر بكثير...</p>
                  <div class="d-table scale-up delay-4 mx-auto mx-lg-0"><a class="btn btn-primary" href="shop-grid-ls.html">تسوق الآن<i class="ci-arrow-right ms-2 me-n1"></i></a></div>
                </div>
              </div>
            </div>
              ...
              <div class="card-body px-3 pt-grid-gutter pb-0">
                <div class="row g-0 ps-1">
                  <div class="col-sm-4 px-2 mb-grid-gutter"><a class="d-block text-center text-decoration-none me-1" href="shop-grid-ls.html"><img class="d-block rounded mb-3" src="img/home/categories/cat-sm01.jpg" alt="Men">
                      <h3 class="fs-base pt-1 mb-0">رجال</h3></a></div>
                  <div class="col-sm-4 px-2 mb-grid-gutter"><a class="d-block text-center text-decoration-none me-1" href="shop-grid-ls.html"><img class="d-block rounded mb-3" src="img/home/categories/cat-sm02.jpg" alt="Women">
                      <h3 class="fs-base pt-1 mb-0">امرأة</h3></a></div>
                  <div class="col-sm-4 px-2 mb-grid-gutter"><a class="d-block text-center text-decoration-none me-1" href="shop-grid-ls.html"><img class="d-block rounded mb-3" src="img/home/categories/cat-sm03.jpg" alt="Kids">
                      <h3 class="fs-base pt-1 mb-0">صغار في السن</h3></a></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="container pt-md-3 pb-5 mb-md-3">
        <h2 class="h3 text-center">المنتجات الرائجة</h2>
        <div class="row pt-4 mx-n2">
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card">
              ...
              <div class="card-body py-2"><a class="product-meta d-block fs-xs pb-1" href="#">Sneakers &amp; كيدز</a>
                <h3 class="product-title fs-sm"><a href="shop-single-v1.html">أحذية رياضية نسائية Colorblock</a></h3>
          ...
          <!-- Product-->
          <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card"><span class="badge badge-danger badge-shadow">تخفيض السعر</span>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card">
              ...
              <div class="card-body py-2"><a class="product-meta d-block fs-xs pb-1" href="#">أحذية رياضية نسائية</a>
                <h3 class="product-title fs-sm"><a href="shop-single-v1.html">حذاء رياضي جلد برقبة عالية</a></h3>
                <div class="d-flex justify-content-between">
        ...
        <div class="text-center pt-3"><a class="btn btn-outline-accent" href="shop-grid-ls.html">المزيد من المنتجات<i class="ci-arrow-right ms-1"></i></a></div>
      </section>
      <!-- Banners-->
          ...
          <div class="col-md-8 mb-4">
            <div class="d-sm-flex justify-content-between align-items-center bg-secondary overflow-hidden rounded-3">
              <div class="py-4 my-2 my-md-0 py-md-5 px-4 ms-md-3 text-center text-sm-start">
                <h4 class="fs-lg fw-light mb-2">أسرع - بسرعة! عرض لوقت محدود</h4>
                <h3 class="mb-4">كونفرس أول ستار للبيع</h3><a class="btn btn-primary btn-shadow btn-sm" href="#">تسوق الآن</a>
            ...
            <div class="d-flex flex-column h-100 justify-content-center bg-size-cover bg-position-center rounded-3" style="background-image: url(img/blog/banner-bg.jpg);">
              <div class="py-4 my-2 px-4 text-center">
                <div class="py-1">
                  ...
                  <p class="fs-sm text-muted">أسرع لحجز مكانك</p><a class="btn btn-primary btn-shadow btn-sm" href="#">اتصل بنا</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-5">
            <div class="d-flex flex-column h-100 overflow-hidden rounded-3" style="background-color: #e2e9ef;">
              <div class="d-flex justify-content-between px-grid-gutter py-grid-gutter">
                <div>
                  <h3 class="mb-1">يوم هوديي</h3><a class="fs-md" href="shop-grid-ls.html">تسوق هوديس<i class="ci-arrow-right fs-xs align-middle ms-1"></i></a>
                </div>
          ...
          <div class="col-md-7 pt-4 pt-md-0">
            <div class="tns-carousel">
              <div class="tns-carousel-inner" data-carousel-options="{&quot;nav&quot;: true, &quot;controlsContainer&quot;: &quot;#hoodie-day&quot;}">
                <!-- Carousel item-->
                <div>
                  <div class="row mx-n2">
                    <div class="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4">
                      <div class="card product-card card-static">
                        ...
                        <div class="card-body py-2"><a class="product-meta d-block fs-xs pb-1" href="#">هوديس &amp; بلوزات</a>
                          <h3 class="product-title fs-sm"><a href="shop-single-v1.html">بلوزة بغطاء للرأس بلون كتلة</a></h3>
                          <div class="d-flex justify-content-between">
                    ...
                    <div class="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4">
                      <div class="card product-card card-static">
                        ...
                        <div class="card-body py-2"><a class="product-meta d-block fs-xs pb-1" href="#">هوديس &amp; هوديس</a>
                          <h3 class="product-title fs-sm"><a href="shop-single-v1.html">بلوزة بغطاء للرأس بلون كتلة</a></h3>
                          <div class="d-flex justify-content-between">
                    ...
                    <div class="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4">
                      <div class="card product-card card-static"><span class="badge badge-danger badge-shadow">تخفيض السعر</span>
                    ...
                    <div class="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4">
                      <div class="card product-card card-static">
                        ...
                        <div class="card-body py-2"><a class="product-meta d-block fs-xs pb-1" href="#">هوديس &amp; بلوزات</a>
                          <h3 class="product-title fs-sm"><a href="shop-single-v1.html">بلوزة بغطاء للرأس أحادية اللون</a></h3>
                          <div class="d-flex justify-content-between">
                  ...
                  <div class="row mx-n2">
                    ...
                    <div class="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4 d-none d-lg-block">
                      <div class="card product-card card-static">
                        ...
                        <div class="card-body py-2"><a class="product-meta d-block fs-xs pb-1" href="#">هوديس &amp; بلوزات</a>
                          <h3 class="product-title fs-sm"><a href="shop-single-v1.html">بلوزة بغطاء للرأس مطبوعة</a></h3>
                          <div class="d-flex justify-content-between">
      ...
      <section class="container py-lg-4 mb-4">
        <h2 class="h3 text-center pb-4">تسوق وفق الماركة</h2>
        <div class="row">
        ...
        <div class="row g-0">
          <div class="col-md-6"><a class="card border-0 rounded-0 text-decoration-none py-md-4 bg-faded-primary" href="blog-list-sidebar.html">
              <div class="card-body text-center"><i class="ci-edit h3 mt-2 mb-4 text-primary"></i>
                <h3 class="h5 mb-1">اقرأ المدونة</h3>
                <p class="text-muted fs-sm">آخر متجر ، أخبار الموضة والاتجاهات</p>
              </div></a></div>
          <div class="col-md-6"><a class="card border-0 rounded-0 text-decoration-none py-md-4 bg-faded-accent" href="#">
              <div class="card-body text-center"><i class="ci-instagram h3 mt-2 mb-4 text-accent"></i>
                <h3 class="h5 mb-1">تابع على Instagram</h3>
                <p class="text-muted fs-sm">#تسوق مع كارتزيلا</p>
              </div></a></div>
        </div>
      </section>
    </main>
