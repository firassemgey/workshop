          ...
          <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-start">
                <li class="breadcrumb-item"><a class="text-nowrap" href="index1.php"><i class="ci-home"></i>الرئيسية</a></li>
                <li class="breadcrumb-item text-nowrap"><a href="#">محل</a>
                </li>
                <li class="breadcrumb-item text-nowrap active" aria-current="page">الشبكة الشريط الجانبي الأيسر</li>
              </ol>
            </nav>
          </div>
          <div class="order-lg-1 pe-lg-4 text-center text-lg-start">
            <h1 class="h3 text-light mb-0">متجر الشبكة الشريط الجانبي الأيسر</h1>
          </div>
        </div>
      </div>
              ...
              <div class="offcanvas-body py-grid-gutter px-lg-grid-gutter">
                ...
                <div class="widget widget-categories mb-4 pb-4 border-bottom">
                  ...
                  <div class="accordion mt-n1" id="shop-categories">
                        ...
                        <div class="accordion-body">
                          <div class="widget widget-links widget-filter">
                            ...
                            <ul class="widget-list widget-filter-list pt-1" style="height: 12rem;" data-simplebar data-simplebar-auto-hide="false">
                              ...
                              <li class="widget-list-item widget-filter-item"><a class="widget-list-link d-flex justify-content-between align-items-center" href="#"><span class="widget-filter-item-text"> مضخات &amp; كعب عالي</span><span class="fs-xs text-muted ms-3">247</span></a></li>
                              ...
                              <li class="widget-list-item widget-filter-item"><a class="widget-list-link d-flex justify-content-between align-items-center" href="#"><span class="widget-filter-item-text">أحذية رياضية</span><span class="fs-xs text-muted ms-3">402</span></a></li>
                              ...
                              <li class="widget-list-item widget-filter-item"><a class="widget-list-link d-flex justify-content-between align-items-center" href="#"><span class="widget-filter-item-text">قباقيب &amp; البغال</span><span class="fs-xs text-muted ms-3">24</span></a></li>
                    ...
                    <!-- Bags-->
                    <div class="accordion-item">
                      <h3 class="accordion-header"><a class="accordion-button collapsed" href="#bags" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="bags">حقائب</a></h3>
                ...
                <div class="widget mb-4 pb-4 border-bottom">
                  <h3 class="widget-title">السعر</h3>
                  ...
                  <ul class="widget-list widget-filter-list list-unstyled pt-1" style="max-height: 11rem;" data-simplebar data-simplebar-auto-hide="false">
                    ...
                    <li class="widget-filter-item d-flex justify-content-between align-items-center mb-1">
                      <div class="form-check">
                        ...
                        <label class="form-check-label widget-filter-item-text" for="armour">تومي هيلفيغر</label>
                      </div><span class="fs-xs text-muted">90</span>
                    </li>
                    <li class="widget-filter-item d-flex justify-content-between align-items-center mb-1">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="urban">
                        <label class="form-check-label widget-filter-item-text" for="urban">تحت الدرع</label>
                      </div><span class="fs-xs text-muted">152</span>
                    </li>
                    <li class="widget-filter-item d-flex justify-content-between align-items-center mb-1">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="vsecret">
                        <label class="form-check-label widget-filter-item-text" for="vsecret">تجار الملابس في المناطق الحضرية</label>
                      </div><span class="fs-xs text-muted">238</span>
                    </li>
                    <li class="widget-filter-item d-flex justify-content-between align-items-center mb-1">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="wolverine">
                        <label class="form-check-label widget-filter-item-text" for="wolverine">سر فيكتوريا</label>
            ...
            <div class="d-flex justify-content-center justify-content-sm-between align-items-center pt-2 pb-4 pb-sm-5">
              <div class="d-flex flex-wrap">
                <div class="d-flex align-items-center flex-nowrap me-3 me-sm-4 pb-3">
                  <label class="text-light opacity-75 text-nowrap fs-sm me-2 d-none d-sm-block" for="sorting">ترتيب حسب:</label>
                  <select class="form-select" id="sorting">
                    ...
                    <option>ترتيب من الألف إلى الياء</option>
                  </select><span class="fs-sm text-light opacity-75 text-nowrap ms-2 d-none d-md-block">of 287 منتجات</span>
                </div>
              </div>
              ...
              <div class="col-md-4 col-sm-6 px-2 mb-4">
                <div class="card product-card">
                  ...
                  <div class="card-body py-2"><a class="product-meta d-block fs-xs pb-1" href="#">أحذية رياضية &amp; كيدز</a>
                    <h3 class="product-title fs-sm"><a href="shop-single-v1.html">أحذية رياضية نسائية ملونة</a></h3>
