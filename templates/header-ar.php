...
<<<<<<< HEAD
                                                    ...
                                                    <li class="widget-list-item"><a class="widget-list-link" href="shop-cart.ar.php">عربة التسوق</a></li>
                                                    <li class="widget-list-item"><a class="widget-list-link" href="checkout-details.ar.php">تفاصيل الدفع</a></li>
                                                    <li class="widget-list-item"><a class="widget-list-link" href="checkout-shipping.ar.php">الخروج - الشحن</a></li>
                                                    <li class="widget-list-item"><a class="widget-list-link" href="checkout-payment.ar.php">الخروج - الدفع</a></li>
                                                    <li class="widget-list-item"><a class="widget-list-link" href="checkout-review.ar.php">تسجيل الخروج - مراجعة</a></li>
...
<<<<<<< HEAD
                                            ...
                                            <li><a class="dropdown-item" href="account-payment.ar.php">طرق الدفع</a></li>
...
<<<<<<< HEAD
                                            ...
                                            <li><a class="dropdown-item" href="dashboard-sales.ar.php">مبيعات</a></li>
                                            <li><a class="dropdown-item" href="dashboard-products.ar.php">منتجات</a></li>
                                            <li><a class="dropdown-item" href="dashboard-add-new-product.ar.php">اضافة منتج جديد</a></li>
                                            <li><a class="dropdown-item" href="dashboard-payouts.ar.php">المدفوعات</a></li>
                                        </ul>
                                    </li>
...
<<<<<<< HEAD
                                            ...
                                            <li><a class="dropdown-item" href="navbar-2-level-dark.ar.php">2 مستوى الظلام</a></li>
                                            <li><a class="dropdown-item" href="navbar-3-level-light.ar.php">3 مستوى الضوء</a></li>
                                            <li><a class="dropdown-item" href="navbar-3-level-dark.ar.php">3 مستوى الظلام</a></li>
                                            <li><a class="dropdown-item" href="home-electronics-store.ar.php">متجر للالكترونيات</a></li>
                                            <li><a class="dropdown-item" href="home-marketplace.ar.php">المتجر</a></li>
                                            <li><a class="dropdown-item" href="home-grocery-store.ar.php">قائمة جانبية (بقالة)</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown-divider"></li>
                                    <li><a class="dropdown-item" href="about.ar.php">معلومات عنا</a></li>
                                    <li><a class="dropdown-item" href="contacts.ar.php">جهات الاتصال</a></li>
